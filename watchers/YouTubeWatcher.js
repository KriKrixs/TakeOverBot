export default class YouTubeWatcher {
    ...
    async getLastVideo(playlistId) {
        ...
        try {
            ...
            await this.loggers.logger.log("WARNING", this.constructor.name, "Error while fetching YouTube videos: " + e.message, e)
            return;
        }
        ...
        try {
            ...
            await this.loggers.logger.log("WARNING", this.constructor.name, "YouTube response seems malformed: " + e.message, e)
        }
    }
}